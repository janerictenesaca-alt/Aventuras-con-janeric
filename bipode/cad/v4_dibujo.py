"""Dibujo técnico en SVG: vistas a escala con cotas, ejes y rótulos."""
import math
...
class Vista:
    ...
    def __init__(self, x0, y0, x1, y1, ancho_mm, margen=None):
        ...
        self.el = []
        self.txt = 2.3 * self.k                  # texto de 2,3 mm en papel
        self.lw = 0.25 * self.k
    ...
    def eje_cruz(self, x, y, r):
        e = r * 1.35
        self.linea((x - e, y), (x + e, y), "eje")
        self.linea((x, y - e), (x, y + e), "eje")
    ...
    def cota(self, a, b, desp, texto=None, tam=1.0):
        ...
        t = texto if texto is not None else f(L)
    ...
    def diametro(self, x, y, r, ang, texto, largo=None):
        ...
        self.texto(p3[0] + (1 if derecha else -1) * self.k, p3[1] + 0.6 * self.k, texto, anc="start" if derecha else "end", cls="ct")
