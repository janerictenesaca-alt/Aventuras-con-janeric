# Notas de los archivos recibidos

## Lote 1 — PDF de SMC TerrAdaptor (no son del Vortex)

### 1. Space Station (SMC, pieza 230600)
- Accesorio para la cabeza del trípode TerrAdaptor. Da **14 puntos de amarre** más.
- 2 módulos: **Libre** (placa naranja que gira sola hacia la carga) y **Fijo** (placa gris que no gira).
- Cada placa: forma de estrella con **7 huecos grandes** alrededor del tubo + 1 "cuerno" (hongo) arriba para pasar una gaza de cuerda sin mosquetón.
- Tubos por colores: tubo gris ("Perf-tube", el delgado) entra en tubo naranja ("Mid-tube", el grueso).
- Pasadores: pasador de pata (con anillo) y pasador principal de **5½" (140 mm)**. El pasador de 4½" (114 mm) del TerrAdaptor es muy corto para esto.
- Regla: el tubo interior debe entrar **completo**; si se ve el texto de aviso, está mal armado.
- **Idea para nuestro diseño:** placa de amarre con huecos alrededor del tubo, que se pone en la cabeza o a media pata.

### 2. Modular Foot System (pies intercambiables)
- **Adaptador de pie:** cilindro que entra en la pata y se asegura con el pasador normal. Arriba tiene 2 orejas con un pasador fijo.
- El pie tiene una **ranura en "L"** que entra en ese pasador y se aprieta con un **tornillo prisionero con guía** (llave Allen). Se puede girar cada **45°**.
- 3 pies:
  - **Talon (garra):** placa con punta larga y punta corta de aluminio, con **puntas de acero templado cambiables** (se sujetan con prisioneros). 2 huecos grandes para amarrar. Sirve para clavar en tierra o apoyarse en tubos, raíces o roca.
  - **Rocker (mecedora):** placa curva ancha. Reparte el peso y permite inclinar mucho la pata. 2 huecos de amarre y un gancho.
  - **Articulado:** base redonda con caucho y rótula. Tiene huecos para fijarla con pernos o estacas al suelo y se puede girar 90° para dejarla plana.
- Consejo: siempre amarrar los pies a anclajes. Nunca usar la pata sin pie, porque la punta del tubo se daña.

### 3. QuickLash
- Punto de amarre extra que se pone **en cualquier hueco de la pata** con un pasador de bola largo (el de la pata es muy corto).
- **30 kN** tirando derecho y **15 kN** tirando de lado (90°).

### 4. Winch Brackets (soporte para winche)
- Placa de aluminio de **3½" × 9" × ½" = 89 × 229 × 12,7 mm**, con 2 placas laterales.
- Se pone en la pata con **3 pasadores de bola largos**. Puede ir justo donde se unen el tubo delgado y el grueso.
- Pernos del winche: apretar a **20 lb·pie (27 N·m)**. Winche Harken: **6–7 lb·pie (8–9,5 N·m)**.
- Uso típico: subir o bajar **135 a 270 kg** (300 a 600 lb). El winche de cabrestante **no frena caídas**: la cuerda de seguridad va aparte.

### Tabla de resistencias SMC (rotura)
| Punto | kN |
|---|---|
| Anillo de amarre, 1 hueco | 20 |
| Anillo de amarre, huecos opuestos | 25 |
| Pies Talon, Rocker y Articulado | 30 |
| QuickLash derecho / de lado | 30 / 15 |
| Soporte de winche | 30 |
| Puntos de la cabeza | 36 |
...
- **Pág. 15, configuraciones:** trípode (marco de anclaje), A-frame (marco direccional), trípode de pata de caballete con winche, A-frame de lado, trípode de pata de caballete con polea direccional y gin pole.
- **Pág. 17:** hay 2 modos de uso. En el **marco de anclaje** la cuerda termina en el Vortex: la fuerza es igual al peso y va por la línea de la carga. En el **marco direccional** la cuerda pasa por una polea: la fuerza es el peso por el factor de la polea y va por la bisectriz entre la cuerda que entra y la que sale.
- **Pág. 18:** con carga, los pies tienden a abrirse. Se controla con una maniota (cinta) entre cada par de pies. La línea de tiro debe ir cerca de la línea de carga.
- **Pág. 19:** en el trípode de pata de caballete, la pata de atrás hay que asegurarla contra tensión, compresión y deslizamiento.
- **Pág. 20, cómo asegurar los pies:** 1) maniotas entre pies, 2) encajados en una grieta, 3) empernados a la roca por los huecos del pie plano, 4) amarrados a un objeto. La cabeza se asegura con vientos: las patas trabajan a compresión y los vientos a tensión. La fuerza en un viento puede ser mayor que la carga. Los vientos deben ser livianos, fuertes, delgados y de muy poco estiramiento.
...
- **TerrAdaptor pág. 17:** para A-frames de lado, las abrazaderas se ponen alternadas (una hacia adelante y otra hacia atrás), para que las patas no choquen y quede más espacio de trabajo bajo la cabeza. Revisar que las abrazaderas no estén deformadas.
- **Pág. 18, pie modular:** el adaptador entra en la pata con el pasador normal. El pie tiene una **ranura en L** que entra en un pasador fijo del adaptador y se traba con un **tornillo de presión con punta guía**, que debe quedar a ras (llave Allen larga). Trae un enlace rápido para la maniota.
...
- Placa frontal 01 ↔ casquillos 02: reforzar la soldadura en las puntas (arriba y abajo de cada lado = 4 puntos) con refuerzos sutiles: cartelitas triangulares chicas (~25 × 25 mm, Al 6061-T6 ~8 mm, esquina redondeada) por la cara de atrás, entre la placa y el tubo. Revisar que no tapen huecos ni ranuras F del casquillo, ventanas E, aletas, pasadores ni el giro de la gin pole. La cara lisa de adelante no cambia.
- Foto 18_AHP_vista_arriba.jpg (AHP original visto desde arriba): el usuario dice que el AHP de v9 quedó mal. En la foto: una sola placa naranja; espiga larga arriba («TO HITCH»); cuerpo ancho con 4 huecos redondos (2 + 2, a los lados); abajo 2 brazos largos en U con la pata entre ellos; pasador de lado cerca de la punta de los brazos («AHP PIN ONLY»); en cada brazo, afuera, una argolla rectangular redondeada para la maniota («HOBBLE STRAP»). Pendiente de lo que el usuario explique.
- AHP (explicación del usuario sobre la foto 18): 3 partes. 1) Punta de arriba (la de la flecha «TO HITCH») = TUBO CUADRADO, reforzado por debajo/por detrás. 2) Centro = cuerpo plano con los 4 huecos (2 + 2). 3) Abajo = 2 brazos (patitas) con las argollas/orejitas a los costados y el pasador. Hacerlo lo más parecido al original. Viene otra foto de la parte de atrás.
